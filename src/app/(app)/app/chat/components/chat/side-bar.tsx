    ...
    <Drawer direction="right">
      ...
      <DrawerContent className="w-screen max-w-screen bg-dark !border-0 text-light p-0">
        ...
        <DrawerHeader className="p-0">
          <DrawerTitle className="flex items-center justify-end w-full text-light p-4 border-b-[1px] border-b-light/10">
            <DrawerClose>
              <X size={20} />
            </DrawerClose>
          </DrawerTitle>
        ...
        <div className="h-full flex flex-col w-full">
          <div className="p-4 flex flex-col gap-y-3 flex-grow">
            <button
              type="button"
              className={cn("w-full text-left px-4 py-3 rounded-md", {
                "bg-blue-500/10 border-blue-800 border-2 text-blue-300": isChat,
              })}
